  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Add Master Skill</h5>
      ...
      <div class="modal-body">
		  <div class="form-group">
		    ...
		    <input type="text" class="form-control" id="skill_name" aria-describedby="skillHelp" placeholder="Skill Name">
		    <small id="skillHelp" class="form-text text-muted">Add only one skill name</small>
		  </div>
      </div>
...
<div class="modal" id="editModal" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Edit Master Skill</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<div class="modal" id="deleteModal" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form>
      <div class="modal-body">
		  <p>You sure want to delete this skill?</p>
      </div>
      <div class="modal-footer">
